...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result) {
            ...
            $area = $city = $post_code = $country = $note = '';
            $software = $source = '';
        } else {
...
// Load slider images (if not already loaded)
$slides = $slides ?? [
    [
...
<head>
    <meta charset="UTF-8" />
    <title>BidTrack – Your Pathway to Smarter Bidding!</title>
    ...
    <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-white border-bottom shadow-sm mb-4 px-2">
                <div class="container-fluid px-0">
                    <a class="navbar-brand d-flex align-items-center gap-2" href="#">
                        <img src="images/logo.png" alt="Logo" class="d-none d-md-block" style="width: 40px; height: 40px;">
        ...
        <section id="about" class="bg-white py-5 px-3 px-md-4">
            <div class="text-center mb-5">
                <h2 class="text-center fw-bold display-6">
                    About
        ...
        <footer class="text-center text-muted small py-3 border-top">
            &copy; <a href="https://bidtrack.xyz" target="_blank" class="text-decoration-none text-primary fw-semibold" rel="noopener noreferrer">
                BidTrack
            </a></strong> | Developed by
            <a href="https://totalofftec.com" target="_blank" rel="noopener noreferrer"
